...
import { Table, TableRow, TableCell, ShadingType } from "docx";
...
export class DocxBuilder extends DocumentBuilder {
  ...
  // Method which build IOList table
  makeMainTable(array, children) {
    for (const item of array) {
      const _table = this.docxTable(item, 6);
      children.push(
        new Table({
...
export class IoDocBuilder extends DocumentBuilder {
  ...
  //Special == LT4000
  reshapeTagListSpecial(tagList, idList, key, value, flag, HmiRef) {
